...
from core.sites.nine_manga_br.pages import get_pages
...
def get_chapter_pages(manga_url: str, chapter: Chapter) -> list[str]:
    ...
    pattern = r"https://br\.ninemanga\.com/manga/([^/]+)\.html"
    search_string_results = re.search(pattern, manga_url)

    if search_string_results:
        manga_name = search_string_results.group(1)
        manga_name = manga_name.replace("+", " ")
        cp_url = f"https://br.ninemanga.com/chapter/{manga_name}/{chapter.id}.html"
